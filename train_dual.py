...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='/home/huyonic/Documents/Yolo/yolov9/models/detect/yolov9_custom.yaml', help='model.yaml path')
    ...
    parser.add_argument('--save-period', type=int, default=-1, help='Save checkpoint every x epochs (disabled if < 1)') #this is checkpoint configer
